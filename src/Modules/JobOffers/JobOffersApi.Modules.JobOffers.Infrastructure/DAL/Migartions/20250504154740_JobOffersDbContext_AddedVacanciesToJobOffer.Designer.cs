...
namespace JobOffersApi.Modules.JobOffers.Infrastructure.DAL.Migartions
{
    ...
    [Migration("20250504154740_JobOffersDbContext_AddedVacanciesToJobOffer")]
    partial class JobOffersDbContext_AddedVacanciesToJobOffer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobOffersApi.Modules.JobOffers.Core.Entities.JobApplication.JobApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("JobOffersApi.Modules.JobOffers.Core.Entities.JobOffer", b =>
                {
                    b.OwnsOne("JobOffersApi.Abstractions.Core.Location", "Location", b1 =>
                        {
